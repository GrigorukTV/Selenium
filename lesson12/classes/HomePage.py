...
class HomePage(BasePage):
    ...
    def get_url_search(self):
        ...
        return self.url_to_be("http://192.168.0.12/index.php?route=product/search&search=iphone")

    def get_url_search_iphone(self):
        self.click_element(self.PRODUCT_LAYOUT_CHILD2)
        return self.url_to_be("http://192.168.0.12/iphone")
    ...
    def get_contact_us(self):
        ...
        return self.url_to_be("http://192.168.0.12/index.php?route=information/contact")
    ...
    def get_footer_link(self):
        ...
        return self.url_to_be("http://192.168.0.12/about_us")
